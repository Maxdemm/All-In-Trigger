...
public class RoomView {
    ...
    private void initializeInfrastructure() {
        // ==========================================
        // 1. СТВОРЕННЯ ЗОН ПІДЛОГИ (10 КІМНАТ ТА КОРИДОРІВ)
        // ==========================================

        // --- Центральний Горизонтальний Ряд ---
        floorAreas.add(new Rectangle(100, 100, 350, 350));   // Кімната 1 (Старт)
        floorAreas.add(new Rectangle(450, 220, 200, 100));   // Коридор 1
        floorAreas.add(new Rectangle(650, 50, 450, 450));    // Кімната 2 (Центр)
        floorAreas.add(new Rectangle(1100, 220, 200, 100));  // Коридор 2
        floorAreas.add(new Rectangle(1300, 100, 400, 400));  // Кімната 3 (Правий фланг)

        // --- Вертикальні Переходи ---
        floorAreas.add(new Rectangle(225, -300, 100, 400));  // Тунель 1 (Вниз від К1)
        floorAreas.add(new Rectangle(825, 500, 100, 300));   // Тунель 2 (Вгору від К2)
        floorAreas.add(new Rectangle(1450, -300, 100, 400)); // Тунель 3 (Вниз від К3)

        // --- Нижній Поверх (Підземелля) ---
        floorAreas.add(new Rectangle(50, -650, 450, 350));   // Кімната 4 (Центральний низ ліво)
        floorAreas.add(new Rectangle(-150, -500, 200, 100)); // Коридор 7 (До Кімнати 9)
        floorAreas.add(new Rectangle(-550, -650, 400, 350)); // Кімната 9 (Стародавній Склеп)

        floorAreas.add(new Rectangle(1300, -650, 400, 350)); // Кімната 6 (Центральний низ право)
        floorAreas.add(new Rectangle(1700, -500, 200, 100)); // Коридор 8 (До Кімнати 10)
        floorAreas.add(new Rectangle(1900, -650, 400, 350)); // Кімната 10 (Лавове Сховище)

        // --- Верхній Поверх (Небесні Зали) ---
        floorAreas.add(new Rectangle(650, 800, 450, 400));   // Кімната 5 (Центральний верх)
        floorAreas.add(new Rectangle(450, 950, 200, 100));   // Коридор 5 (До Кімнати 7)
        floorAreas.add(new Rectangle(50, 800, 400, 400));    // Кімната 7 (Магічна Лабораторія)

        floorAreas.add(new Rectangle(1100, 950, 200, 100));  // Коридор 6 (До Кімнати 8)
        floorAreas.add(new Rectangle(1300, 800, 450, 400));  // Кімната 8 (Королівська Скарбниця)

        // ==========================================
        // 2. СТВОРЕННЯ ДВЕРЕЙ ТА ПЕРЕХОДІВ
        // ==========================================
        ...
        doors.add(new DoorView(50, -500, 20, 100));   // Вхід у Склеп (К9)
        doors.add(new DoorView(430, 950, 20, 100));   // Вхід у Лабораторію (К7)
        doors.add(new DoorView(1300, 950, 20, 100));  // Вхід у Скарбницю (К8)

        doors.get(0).setOpen(true);

        // ==========================================
        // 3. СТВОРЕННЯ СТІН (Повністю закритий периметр)
        // ==========================================

        // --- Кімната 1 (Старт) ---
        walls.add(new WallView(100, 450, 350, 15));   // Верхня
        walls.add(new WallView(100, 100, 125, 15));   // Нижня ліва (до тунелю)
        walls.add(new WallView(325, 100, 125, 15));   // Нижня права (після тунелю)
        walls.add(new WallView(100, 115, 15, 335));   // Ліва бічна
        walls.add(new WallView(435, 100, 15, 120));   // Права бічна нижня (до коридору)
        walls.add(new WallView(435, 320, 15, 130));   // Права бічна верхня (після коридору)
        ...
        // --- Кімната 2 (Центр) ---
        walls.add(new WallView(650, 500, 175, 15));   // Верхня ліва (до тунелю)
        walls.add(new WallView(925, 500, 175, 15));   // Верхня права (після тунелю)
        walls.add(new WallView(650, 40, 450, 10));    // Нижня суцільна
        walls.add(new WallView(650, 50, 15, 170));    // Ліва бічна нижня
        walls.add(new WallView(650, 320, 15, 180));   // Ліва бічна верхня
        walls.add(new WallView(1085, 50, 15, 170));   // Права бічна нижня
        walls.add(new WallView(1085, 320, 15, 180));  // Права бічна верхня

        // Коридор 2
        walls.add(new WallView(1100, 320, 200, 15));
        walls.add(new WallView(1100, 210, 200, 10));

        // --- Кімната 3 (Правий фланг) ---
        walls.add(new WallView(1300, 500, 400, 15));  // Верхня
        walls.add(new WallView(1300, 100, 150, 15));  // Нижня ліва
        walls.add(new WallView(1550, 100, 150, 15));  // Нижня права
        walls.add(new WallView(1700, 100, 15, 400));  // Права зовнішня суцільна
        walls.add(new WallView(1300, 100, 15, 120));  // Ліва бічна нижня
        walls.add(new WallView(1300, 320, 15, 180));  // Ліва бічна верхня

        // --- Вертикальні сполучні тунелі ---
        walls.add(new WallView(210, -300, 15, 400));  // Т1 Ліва
        walls.add(new WallView(325, -300, 15, 400));  // Т1 Права
        walls.add(new WallView(810, 500, 15, 300));   // Т2 Ліва
        walls.add(new WallView(925, 500, 15, 300));   // Т2 Права
        walls.add(new WallView(1435, -300, 15, 400)); // Т3 Ліва
        walls.add(new WallView(1550, -300, 15, 400)); // Т3 Права

        // --- Кімната 4 та ліве крило Склепу (К9) ---
        ...
        walls.add(new WallView(50, -300, 175, 15));   // [ВИПРАВЛЕНО] Розширено з 160 до 175 для тунелю
        // Коридор 7
        ...
        // --- Кімната 6 та праве крило Кузні (К10) ---
        ...
        walls.add(new WallView(1300, -300, 150, 15)); // [ВИПРАВЛЕНО] Розширено з 135 до 150 для тунелю
        ...
        // --- Кімната 5 (Центральний верхній ярус) ---
        walls.add(new WallView(650, 1185, 450, 15));  // Верхня
        walls.add(new WallView(650, 800, 175, 15));   // [ДОДАНО] Нижня ліва (до тунелю Т2)
        walls.add(new WallView(925, 800, 175, 15));   // [ДОДАНО] Нижня права (після тунелю Т2)
        walls.add(new WallView(650, 800, 15, 150));   // Ліва нижня
        walls.add(new WallView(650, 1050, 15, 150));  // Ліва верхня
        walls.add(new WallView(1085, 800, 15, 150));  // Права нижня
        walls.add(new WallView(1085, 1050, 15, 150)); // Права верхня

        // Лабораторія (К7) та її коридор
    ...
    public void render(SpriteBatch batch, float time) {
        ...
        // ==========================================
        // 1. СТАТИЧНА ПІДЛОГА ТА СІТКА ДЛЯ ВСІХ ЗОН
        // ==========================================
        ...
        // Плиточний декор по всьому світу
        ...
        // ==========================================
        // 4. ВІЗУАЛІЗАЦІЯ ДВЕРЕЙ ТА СТІН ПОВЕРХ ПІДЛОГИ
        // ==========================================
